...
describe('Corrupted files', () => {
	it('Signature byte 1 MSBit reset to zero', () => {
		...
		expect(() => new PngDecoder(image)).toThrow('Not a PNG file');
	});
