...
describe('Basic formats', () => {
	it('black & white', (t: TestContext) => {
		const image = fs.readFileSync(path.join(testdataDir, 'basic-formats', 'basn0g01.png'));
	...
	it('2 bit (4 level) grayscale', (t: TestContext) => {
		const image = fs.readFileSync(path.join(testdataDir, 'basic-formats', 'basn0g02.png'));
		const png = new PngDecoder(image);
	...
	it('4 bit (16 level) grayscale', (t: TestContext) => {
		const image = fs.readFileSync(path.join(testdataDir, 'basic-formats', 'basn0g04.png'));
		const png = new PngDecoder(image);
	...
	it('8 bit (256 level) grayscale', (t: TestContext) => {
		const image = fs.readFileSync(path.join(testdataDir, 'basic-formats', 'basn0g08.png'));
		const png = new PngDecoder(image);
	...
	it('16 bit (64k level) grayscale', (t: TestContext) => {
		const image = fs.readFileSync(path.join(testdataDir, 'basic-formats', 'basn0g16.png'));
		const png = new PngDecoder(image);
	...
	it('3x8 bits rgb color', (t: TestContext) => {
		const image = fs.readFileSync(path.join(testdataDir, 'basic-formats', 'basn2c08.png'));
		const png = new PngDecoder(image);
	...
	it('3x16 bits rgb color', (t: TestContext) => {
		const image = fs.readFileSync(path.join(testdataDir, 'basic-formats', 'basn2c16.png'));
		const png = new PngDecoder(image);
	...
	it('1 bit (2 color) paletted', (t: TestContext) => {
		const image = fs.readFileSync(path.join(testdataDir, 'basic-formats', 'basn3p01.png'));
		const png = new PngDecoder(image);
	...
	it('2 bit (4 color) paletted', (t: TestContext) => {
		const image = fs.readFileSync(path.join(testdataDir, 'basic-formats', 'basn3p02.png'));
		const png = new PngDecoder(image);
	...
	it('4 bit (16 color) paletted', (t: TestContext) => {
		const image = fs.readFileSync(path.join(testdataDir, 'basic-formats', 'basn3p04.png'));
		const png = new PngDecoder(image);
	...
	it('8 bit (256 color) paletted', (t: TestContext) => {
		const image = fs.readFileSync(path.join(testdataDir, 'basic-formats', 'basn3p08.png'));
		const png = new PngDecoder(image);
	...
	it('8 bit grayscale + 8 bit alpha-channel', (t: TestContext) => {
		const image = fs.readFileSync(path.join(testdataDir, 'basic-formats', 'basn4a08.png'));
		const png = new PngDecoder(image);
	...
	it('16 bit grayscale + 16 bit alpha-channel', (t: TestContext) => {
		const image = fs.readFileSync(path.join(testdataDir, 'basic-formats', 'basn4a16.png'));
		const png = new PngDecoder(image);
	...
	it('3x8 bits rgb color + 8 bit alpha-channel', (t: TestContext) => {
		const image = fs.readFileSync(path.join(testdataDir, 'basic-formats', 'basn6a08.png'));
		const png = new PngDecoder(image);
	...
	it('3x16 bits rgb color + 16 bit alpha-channel', (t: TestContext) => {
		const image = fs.readFileSync(path.join(testdataDir, 'basic-formats', 'basn6a16.png'));
		const png = new PngDecoder(image);
